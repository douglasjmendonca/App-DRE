...
st.write('## Processo de Conteúdo de Programação')
...
with st.container(): # Processo de Conteúdo de Programação
# Processo de Conteúdo de Programação
    def process_excel_programacao(uploaded_file):
        ...
        # Incluindo as colunas mes e data no Data Frame de entrada
    ...
    # Tratamento dos dados de Conteúdo de Programação
        ...
        # Completando as colunas DataFrame de tratamento para que possam ser complementadas com conteúdo posteriormente
        tratamento = pd.DataFrame(tratamento, columns = ['CIDADE','DATA','VALOR', 'HISTORICO', 'IDCC', 'CENTRO_CUSTOS', 'IDCONTA', 
                                          'CONTA', 'IDCLVL'])
        
        # Preenchendo o valor do centro de custos com dados de descrição padrão
        tratamento['CENTRO_CUSTOS'] = 'TV'
        
        # Preenchendo o valor da conta com dados de descrição padrão
...
with st.container(): #Funções e botões para o processamento do arquivo
    ...
    nome_padraof = 'conteudo_programacao_DRE_' + mes + ano + '.xlsx'
    ...
    with coluna2:
        ...
        if uploaded_file:
            ...
            processed_file = process_excel_programacao(uploaded_file)
